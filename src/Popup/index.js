...
const DEFAULT_OPTIONS = {
  ...
  tweenIn: (el, popup) => {
    ...
    TweenLite.to(popup.backdrop, 0.3, { opacity: 1,
      onComplete: () => {
        TweenLite.fromTo(el, 0.3, { yPercent: -50, x: -5, xPercent: -50, opacity: 0, display: 'block' }, { yPercent: -50, xPercent: -50, x: 0, opacity: 1 })
      }
    })
  },
  ...
  tweenOut: (popup) => {
    ...
    TweenLite.to(popup.backdrop, 0.3, { opacity: 0,
      onComplete: () => {
